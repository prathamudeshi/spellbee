...
function openAvatarSelectionPage() {
  ...
  gamePlayPage.style.display = "none";
  console.log(
    "clicked small player pic next button",
    document.querySelector("#small-player-pic")
  );
...
function checkWinner() {
  if (
    firstCorrectLetter.classList.contains("correct-bg") &&
...
interact(".dropzone").dropzone({
  ...
  ondrop: function (event) {
    if (
      event.relatedTarget.textContent.trim() == event.target.textContent.trim()
    ) {
